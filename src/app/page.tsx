...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description: "High-performance data pipeline processing 100K+ blog posts with semantic search capabilities",
    ...
    },
    {
      ...
      description: "Unified platform integrating prescriber data for 9000+ Walgreens locations",
    ...
    },
    {
      ...
      description: "Real-time system for equipment failure prediction and maintenance",
      category: "Innovation",
  ...
  const experience = [
    {
      ...
      location: "India",
      period: "2022 - 2024",
      logo: "/Cognizant-Logo-sq.png", // Add logo path
    ...
    },
    {
      ...
      location: "India",
      period: "2021",
      logo: "Airports_Authority_of_India_logo.svg.png", // Add logo path
      details: [
    ...
    <div className="max-w-3xl">
      ...
      >
        ...
        <p className="text-xl text-slate-300 mb-12 max-w-2xl">
          Specializing in high-throughput architectures with proven 60% cost reduction. 
          Building fault-tolerant pipelines processing 1M+ events/second using AWS/Azure.
        </p>
  ...
  >
    <ChevronDown className="w-6 h-6" />
      ...
      <section id="work" className="py-32 bg-gradient-to-b from-slate-100 to-white">
            ...
            >
              <div className="grid md:grid-cols-[1fr_2fr] gap-8">
                <div className="relative">
                  {/* Company Logo */}
                  <div className="mb-6 w-28 h-28 rounded-lg overflow-hidden bg-white shadow-md">
                    <img
                      src={job.logo}
                ...
                <div>
                  {job.project && (
                    <h4 className="text-xl font-semibold text-slate-800 mb-4">{job.project}</h4>
                  )}
      ...
      {/* Projects Section */}
      <section id="projects" className="py-32 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
              ...
              >
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className={`${index % 2 === 0 ? 'md:order-1' : 'md:order-2'}`}>
                    ...
                    <h3 className="text-3xl font-bold mt-2 mb-4 text-white">{project.title}</h3>
                    <p className="text-slate-300 mb-6">{project.description}</p>
                    <p className="text-sm text-slate-400 font-mono">{project.technologies}</p>
                  </div>
...
<section id="skills" className="py-32 bg-gradient-to-b from-blue-900 to-slate-900">
  <div className="max-w-7xl mx-auto px-6">
    <motion.div
      ...
      className="mb-16"
    >
      <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-wide">Technical Skills</h2>
      <div className="h-1 w-20 bg-blue-500" />
    </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-12">
              Looking to build innovative data solutions? Let's discuss how we can work together.
            </p>
            <div className="flex justify-center gap-8">
              <a 
                href="ghazishaik5@gmail.com"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4">
              <span className="text-sm text-gray-500">© 2024 Ghazi Rahman Shaik. All rights reserved.</span>
